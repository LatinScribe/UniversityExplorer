...
public class ResultsDataAccessObject implements ResultsUserDataAccessInterface {
    ...
    /**
     * Returns a JSONObject which includes a JSONArray of elements containing one university's statistics.
     * @param searchparameters
     * @return JSONObject containing a JSONArray of a university's statistics.
     */
    @Override
